...
/**
 * 6中加密方法
 * @property {String} hex_md5
 * @property {String} b64_md5
 * @property {String} str_md5
 * @property {String} hex_hmac_md5
 * @property {String} b64_hmac_md5
 * @property {String} str_hmac_md5
 * @return {String<base-64>} 十六进制或base-64编码的字符串
 */
...
/* 将小端(little-endian)字节序转换为hex字符串 */
...
/* 将小端(little-endian)字节序转换为base-64字符串 */
