...
<div class="extend-header">
    ...
    <div class="content"><div class="children"><ul><li><a href="/tools/git">Git</a></li><li><a href="/tools/npm">NPM</a></li><li><a href="/tools/markdown">Markdown</a></li><li><a href="/tools/qiankun">乾坤微服务</a></li><li><a href="/tools/charts">ECharts图表库</a></li><li><a href="/tools/vscode">VSCode</a></li><li><a href="/tools/chromeTools">chromeTools</a></li><li><a href="/tools/uml">uml</a></li><li><a href="/tools/regularExpression">正则表达式</a></li><li><a href="/tools/eslint">ESLint</a></li><li><a href="/tools/htmlBundler">html-bundler</a></li></ul></div><div class="links">
<ul class="desc">
...
- [iconfont](http://www.iconfont.cn/search/index?searchType=icon&q=user)
- [开发资源库](https://www.awesomes.cn/)
- 懒盘聚合<br>
    http://yun.misiai.com/  可搜索百度云资源<br>
    https://www.dalipan.com/ 可搜索蓝奏云／百度云，软件／工具<br>
    www.lzpan.com
- CDN资源<br>
    jquery http://libs.useso.com/js/jquery/1.10.2/jquery.min.js
- Vue.js devtools(谷歌/开发)<br>
    内测应用发布、管理平台  https://www.pgyer.com/<br>
...
- [TaobaoFED|淘宝前端团队]( http://taobaofed.org/)
- [SDC设计师网址导航](http://hao.uisdc.com/)
- [前端收录](http://www.helloweba.com/nav.html)
- [JavaScript资源大全中文版]( https://github.com/jobbole/awesome-javascript-cn)
- [WEB前端开发](http://www.css88.com/)
...
- [React学习资源汇总](https://github.com/tsrot/study-notes/blob/master/)
...
- [React 应用的性能优化之路](https://github.com/xitu/gold-miner/blob/master/TODO/)
...
<div style="font-size:12px; text-align:right">    
    ...
    <div style="text-align:left">
        <strong>▉单位符号</strong><br>   
        ° ′ 〃 ° ′ ″ ＄ ￥ 〒 ￠ ￡ ％ ＠ ℃ ℉ ﹩ ﹪ ‰ ﹫ ㎡ ㏕ ㎜ ㎝ ㎞ ㏎ m³ ㎎ ㎏ ㏄ º % $º¹²³ ㎎ ㎏ ㎜ ㎝ ㎞ ㎡ ㏄ ㏎ ㏑ ㏒ ㏕ ℡ ％ ‰ ℃ ℉ ° ′ ″ ＄ ￡ ￥ ￠ ℅ <br>
        <strong>▉货币符号</strong><br>   
        € £ Ұ ￥ ₴ $ ₰ ¢ ₤ ¥ ₳ ₲ ₪ ₵ 元 ₣ ₱ ฿ ₡ ₮ ₭ ₩ ރ円 ₢ ₥ ₫ ₦ z ł ﷼ ₠ ₧ ₯ ₨ K č र ₹ ƒ ₸ ￠<br>
        <strong>▉法律符号</strong><br> 
        ® © ℗ ™ ℠ <br>
        <strong>▉货币</strong><br> 
        $ ¢ £ ¤ € ¥ ₱ ₹ <br>
        <strong>▉音乐符号</strong><br> 
        ♩ ♪ ♫ ♬ ♭ ♮ ♯ <br>
        <strong>▉天空、植物</strong><br> 
        ☽ ☾ ♂ ♀ ☿ ♁ ♃ ♄ ♅ ♆ ♇  <br>
        <strong>▉星座</strong><br> 
        ♈ ♉ ♊ ♋ ♌ ♍ ♎ ♏ ♑ ♒ ♓ ♐ <br>
        <strong>▉象棋，扑克牌</strong><br> 
        ♚ ♛ ♜ ♝ ♞ ♟ ♔ ♕ ♖ ♗ ♘ ♙ ♠ ♣ ♥ ♦ ♤ ♧ ♡ ♢ <br>
...
<div style="font-size:20px; text-align:right">    
    ...
    <div style="text-align:left">
        ...
        ❥ ❤ ✈ ☜ ☞ ☚ ☛ ☟ ✎ ✐ ✏ ✑ ✒ ☯ ❂ ☥ ☮  ☪ ☤ ⚓ ☣ ☦ ☭ ♨<br> 
        ⌒ ‿ 卐 § ∏ ❣ ღ 〓 ๑ ۩ ☊ ☋ ☌ ☍ ｡ ஐ ⌘ ϡ ۵ ⚘ ☧ ☬ 큐 № ℞ ¶ ∼<br> 
        <div style="font-size:60px;font-family:source-code-pro, Menlo, Monaco, Consolas, 'Courier New', monospace"></div>
        <div style="font-size:40px;text-align:left;font-family:source-code-pro, Menlo, Monaco, Consolas, 'Courier New', monospace">
        ┏━┳┓┌─┬┐┍━┯┑┎─┰┒╔═╦╗╓─╥╖╒═╤╕ ┌╮╭╮╭╮ ┮┭┲┱┟╁┧┢╈┪╆╅┾┽╊╉ <br>
        ┃ ┃┃│ │││ ││┃ ┃┃║ ║║║ ║║│ ││ ││││╰╯ ┶┵┺┹┞╀┦┡╇┩╄╃┾┽╊╉ <br>
        ┣━╋┫├─┼┤┝━┿┥┠─╂┨╠═╬╣╟─╫╢╞═╪╡ ╰┘╰╯<br>
        ┗━┻┛└─┴┘┕━┷┙┖─┸┚╚═╩╝╙─╨╜╘═╧╛ <br>
