...
[场景](#场景) - [理念趋势](#理念趋势) - [目前主流方案](#目前主流方案) - [微前端架构](#微前端架构) - [如何搭建一个微前端项目](#如何搭建一个微前端项目) - [搭建基座](#搭建基座) - [搭建/改造子应用](#搭建/改造子应用) - [以VUE为基座(vue-cli 3+生成的vue 2.x项目)](#以VUE为基座(vue-cli 3+生成的vue 2.x项目)) - [安装qiankun](#安装qiankun) - [注册微应用 在主应用中](#注册微应用 在主应用中) - [生命周期钩子 在入口导出](#生命周期钩子 在入口导出) - 
